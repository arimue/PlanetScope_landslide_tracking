...
for refdem in [path +"/DEMdata/output_AW3D30_epsg32720_NASADEMaligned.tif", path +"/DEMdata/output_COP30_epsg32720_NASADEMaligned.tif",path +"/DEMdata/output_NASADEM_epsg32720.tif", path+"/DEMdata/run-DEM_NASADEMaligned.tif"]:

    img2r = core.improve_L1B_geolocation(amespath, img1, img2, refdem, epsg = 32720, order = 2, add_elev = True)
    ...
    prefix = f"{id1}_{id2}_remapped_order2_addElev_{demfn[:-4]}"
