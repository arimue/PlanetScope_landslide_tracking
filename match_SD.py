...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 18 15:38:42 2022
...
def impute(arr, max_fillsize = 500):
...
def estimate_dem_error(files, direction, method = "median", plot = False):
...
dem_err_x = f"./SD_Jujuy_all/stereo/dem_error_dx_mean_bm.tif"
dem_err_y = f"./SD_Jujuy_all/stereo/dem_error_dy_mean_bm.tif"
...
# dem_err_x = estimate_dem_error(corrfx, "x",method = "mean", plot = True)
# dem_err_y = estimate_dem_error(corrfy, "y",method = "mean", plot = True)
# dem_err_x = estimate_dem_error(corrfx, "x",method = "median", plot = True)
# dem_err_y = estimate_dem_error(corrfy, "y",method = "median", plot = True)

df = pd.read_csv(path+"sd_matches_crossangle.csv")
...
# files = sorted(glob.glob("/home/ariane/Documents/PlanetScope/SD_Jujuy_5deg/stereo/*_dy_corrected.tif"))
# matf.plot_offset_results(files, outfile="dy_raw_corrected.png")
# # for f in files:
